...
from Region.database.authorize import add_auth, is_auth, rem_auth, is_auth, get_auth
from Region.utils.decorators import get_users, user_check_template
from Region import pbot as app, OWNER, TRIGGERS, LOGS

@app.on_message(filters.user(OWNER) & filters.command('auth', prefixes=TRIGGERS))
...
@app.on_message(filters.user(OWNER) & filters.command('remauth', prefixes=TRIGGERS))
